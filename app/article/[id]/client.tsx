        ...
        <div className="mb-6 sm:mb-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 mb-4 sm:mb-6">
            ...
            <div className="order-2 md:order-1 md:col-span-2">
              ...
              {article.subheadline && (
                <p className="text-base sm:text-lg md:text-xl text-muted-foreground mb-3 sm:mb-4">{article.subheadline}</p>
              )}
              
              {/* Metadata Row */}
              <div className="flex flex-wrap items-center gap-2 sm:gap-3 text-xs sm:text-sm text-muted-foreground border-t border-b border-border py-2 sm:py-3">
                <div className="flex items-center gap-2">
                  <div className="w-7 h-5 sm:w-8 sm:h-6 rounded-full bg-primary text-primary-foreground flex items-center justify-center text-xs font-semibold">
                    {article.source.logo}
                  </div>
              ...
              {/* AI Byline */}
              <p className="text-xs sm:text-sm text-muted-foreground italic mt-2 sm:mt-3">
            ...
            <div className="order-1 md:order-2 flex justify-center md:justify-end">
              <div className="relative w-full max-w-md h-48 sm:h-56 md:h-64 bg-muted rounded-lg overflow-hidden">
                <Image 
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8">
          ...
          <aside className="lg:col-span-3 space-y-4 sm:space-y-6">
            ...
            <CompaniesTagsWidget
              ...
              stockSymbols={article.entities.stockSymbols}
            />
